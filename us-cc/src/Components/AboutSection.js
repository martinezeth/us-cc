  ...
  return (
    <Box p={2} shadow="md" borderWidth="1px" bg="white" rounded="md">
      <VStack spacing={4} align="start">
        ...
        <Text fontSize="md">
          At Crisis Companion, we are dedicated to enhancing disaster response efforts through advanced coordination and real-time information systems. Our platform serves as a hub for communities and local authorities, enabling effective communication and resource management to inform and empower populations during critical times.
        </Text>
        <Text fontSize="md">
          Crisis Companion leverages technology to streamline responses to natural disasters and emergencies, bridging gaps between individuals, organizations, and government agencies. Join us in making a significant impact in crisis management and response.
        </Text>
