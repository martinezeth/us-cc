    ...
    return (
        <>
            ...
            >
                ...
                />
                <Text fontSize="lg">
                    During a wildfire, your actions can significantly impact your safety and the safety of those around you. Here’s what you should do during a wildfire:
                </Text>
                <OrderedList spacing={3} fontSize="lg">
                    <ListItem>
                ...
                <Box
                    ...
                    marginX="auto" // Centers the Box horizontally
                />
                <Text fontSize="lg">After a wildfire, it's essential to prioritize safety while beginning the recovery process. Here are some steps to follow once it's safe to return to your area: </Text>
                <OrderedList spacing={3} fontSize="lg">
                    <ListItem>
